...
Original file is located at
    https://colab.research.google.com/drive/1oH1WYLDwU0025xRP36ECMypUqBx0J9oX
"""
...
y_ord = df['Urgency'].astype(np.int32).values.flatten() - 1  # 0-based
...
df['Requirement_Text'] = df['Requirement_Text'].apply(lambda t: re.sub(r'[^a-z0-9\s]', '', str(t).lower()))
X_texts = df['Requirement_Text'].tolist()
y_ord = df['Urgency'].astype(np.int32).values.flatten() - 1
...
model.save('final_urgency_model.keras')
