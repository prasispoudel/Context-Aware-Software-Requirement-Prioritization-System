# -*- coding: utf-8 -*-
"""Security_Sensitivity.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ug7kR0RUBjXe6Qz-byCTIm2PN3RwTj8n
"""
...
y_ord = df['Security_Sensitivity'].astype(np.int32).values.flatten() - 1  # 0-based
...
df['Requirement_Text'] = df['Requirement_Text'].apply(lambda t: re.sub(r'[^a-z0-9\s]', '', str(t).lower()))
X_texts = df['Requirement_Text'].tolist()
y_ord = df['Security_Sensitivity'].astype(np.int32).values.flatten() - 1
