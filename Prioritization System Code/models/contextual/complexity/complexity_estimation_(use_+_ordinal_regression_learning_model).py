# -*- coding: utf-8 -*-
"""Complexity Estimation (USE + Ordinal Regression Learning Model).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YMIHIlq2ZJXwS0xTEMyrv2W0D1sgXXjK
"""
...
model.compile(
    ...
    metrics=['loss'] # Added 'loss' as a metric to monitor val_loss
)
